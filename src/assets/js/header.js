function loadHeader(options) {
    ...
    const responseDecoderPath = `${basePath}/responsedecoder/`;
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="toolSelectDropdown">
                        ...
                        <li><a class="dropdown-item ${isActive('responsedecoder') ? 'active' : ''}" href="${responseDecoderPath}">Response Decoder</a></li>
                    </ul>
                </div>
            </div>
        </div>
